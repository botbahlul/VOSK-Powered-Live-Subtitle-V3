...
In my opinion this translate methode give a better accuracy with the cost in performance due to its asynchronous behavior. Also it has more languages support compared to MLKIT Translate API.
